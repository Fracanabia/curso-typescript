...
const avaliacoes: Array<number> = [1, 2, 3, 4, 5, 6, 7];
avaliacoes.push(8.8);
// avaliacoes.push("8.8");
...
const filaNova = new Fila<number>(1, 2, 3, 4, 5);
// const outraFilaNova = new Fila<boolean>(true, false);
